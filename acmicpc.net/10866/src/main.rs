...
fn main() {
    ...
    for _ in 0..command_count {
        ...
        match argv[0] {
            "push_front" => queue.push_front(argv[1].parse::<i32>().unwrap()),
            "push_back" => queue.push_back(argv[1].parse::<i32>().unwrap()),
            "pop_front" => println!("{}", queue.pop_front().unwrap_or(-1)),
            "pop_back" => println!("{}", queue.pop_back().unwrap_or(-1)),
